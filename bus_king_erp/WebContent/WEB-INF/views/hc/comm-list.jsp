...
<main>
   ...
   <form action="comm-list.do" method="get" id="frm">
         <select name="comm_year_d" id="comm_year_d" class="acTHead-select">
            <option>==연도==</option>
                <c:forEach items="${ylist}" var="ylist">
                  <option value="${ylist.comm_year}">${ylist.comm_year}연도</option>
               </c:forEach>
         </select>&nbsp;&nbsp; <select name="comm_month_d" class="acTHead-select">
            <option>==월==</option>
               <c:forEach items="${mlist}" var="mlist">
                  <option value="${mlist.comm_month}">${mlist.comm_month}월</option>
               </c:forEach>
         </select>&nbsp;&nbsp; <select name="comm_day_d" class="acTHead-select">
            <option>==일자==</option>
